...
/**
 * help_cd - this displays information on the shellof builtin command 'cd'
 */
...
/**
 * help_exit -this displays information on the shellof builtin command 'exit'
 */
...
void help_exit(void)
{
	...
	write(STDOUT_FILENO, msg, _strlen(msg));
	msg = "STATUS argument is the integer used to exit shell.";
	write(STDOUT_FILENO, msg, _strlen(msg));
...
/**
 * help_help - this displays information on the shellof builtin command 'help'
 */
...
/**
 * help_all - this displays all possible builtin shellof commands
 */
...
/**
 * help_alias - this displays information on the shellof
